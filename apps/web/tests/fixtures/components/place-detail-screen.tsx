...
import { PlaceDetailActions } from "@/components/domain/place/place-detail-actions";
import { PlaceDetailHeader } from "@/components/domain/place/place-detail-header";
import { PlaceIntroduction } from "@/components/domain/place/place-introduction";
import { PlaceInformation } from "@/components/domain/place/place-information";
import { PlaceDetailPreparation } from "@/components/domain/place/place-detail-preparation";
import { PlaceDetailTabs } from "@/components/domain/place/place-detail-tabs";
import { PlaceReviewOverview } from "@/components/domain/review/place-review-overview";
