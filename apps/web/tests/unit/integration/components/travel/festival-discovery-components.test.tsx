...
import { FestivalFeatureBanner } from "@/components/domain/festival/festival-feature-banner";
import { FestivalFilterGroup } from "@/components/domain/festival/festival-filter-group";
...
describe("FestivalRankingShowcase", () => {
  ...
  it("prioritizes the active festival and defers hidden image layers", () => {
    ...
    const activeImage = container.querySelector('[data-ranking-layer="active"][aria-hidden="false"] img');
    ...
    for (const image of container.querySelectorAll('[data-ranking-layer][aria-hidden="true"] img')) {
      expect(image).toHaveAttribute("loading", "lazy");
    }
    for (const image of container.querySelectorAll('[data-ranking-layer="compact"][aria-hidden="false"] img')) {
