...
import { AiTripScheduleBanner } from "@/components/domain/course/ai-trip-schedule-banner";
...
import { SavedCourseCard } from "@/components/domain/course/saved-course-card";
import { TripScheduleCard } from "@/components/domain/course/trip-schedule-card";
import {
  TripScheduleTabs,
              ...
              {activeTrips.map((trip, index) => (
                <li key={trip.id}>
                  <TripScheduleCard
                    trip={trip}
                    onOpen={openTrip}
                    eager={!showSavedCourses && index < 2}
                  />
                </li>
              ))}
            </ul>
