...
import { LiveCourseContent } from "@/features/places/components/live-place-course-content";
import { LiveGeneratedCourseContent } from "@/features/courses/components/live-generated-course-content";
import { LiveInformationContent } from "@/features/places/components/live-place-information-content";
import { LivePlaceReviewList } from "@/components/domain/review/live-place-review-list";
import { ErrorState as LoadFailureNotice } from "@/components/patterns/error-state/error-state";
import { PlaceDetailHeader } from "@/components/domain/place/place-detail-header";
import { PlaceDetailTabs } from "@/components/domain/place/place-detail-tabs";
import { PlaceImageGallery } from "@/components/domain/place/place-image-gallery";
