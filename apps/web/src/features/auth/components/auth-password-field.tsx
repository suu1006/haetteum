  ...
  return (
    <div className="relative">
      ...
      <Input
        ...
        className="h-14 w-full rounded-2xl border border-border bg-card pr-11 pl-11 type-body-md md:text-[0.875rem] text-foreground outline-none placeholder:text-muted-foreground focus-visible:ring-3 focus-visible:ring-ring/25"
        {...inputProps}
      />
      <button
        type="button"
