  ...
  return (
    ...
    >
      <article
        ...
        className="relative aspect-[4/5] overflow-hidden rounded-[1.125rem] bg-primary text-image-foreground shadow-floating"
      >
        <FestivalRemoteImage
...
function FestivalRankingCompactCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="relative block aspect-[4/5] overflow-hidden rounded-xl bg-primary-subtle">
          <FestivalRemoteImage
            src={festival.image.src}
            alt={festival.image.alt}
