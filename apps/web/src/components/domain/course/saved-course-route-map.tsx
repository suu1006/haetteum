    ...
    <>
      ...
      <Dialog.Root open={expanded} onOpenChange={setExpanded}>
        <Dialog.Portal>
          ...
          <Dialog.Viewport className="items-center p-4">
            <Dialog.Popup className="flex h-[calc(100dvh-2rem)] max-w-[30rem] flex-col overflow-hidden rounded-[1.75rem] data-ending-style:scale-[0.98] data-starting-style:scale-[0.98]">
