...
import { SearchInput } from "@/components/patterns/search-bar/search-input";
...
const searchErrorMessage =
  "관광지를 불러오지 못했어요. 잠시 후 다시 시도해 주세요.";
  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Viewport className="items-end overflow-y-auto sm:items-center sm:p-4">
          <Dialog.Popup
            initialFocus={inputRef}
            className="flex h-[60dvh] max-w-[30rem] flex-col overflow-hidden rounded-t-[1.75rem] data-ending-style:translate-y-2 data-starting-style:translate-y-2 sm:h-[38rem] sm:max-h-[60dvh] sm:rounded-[1.75rem]"
          >
...
<SearchInput
            ...
            >
              {query.trim() === "" ? (
                ...
                <LoadingState>관광지를 찾고 있어요...</LoadingState>
              ) : searchState === "ready" ? (
